...
- **Producer** — any implementation that emits Entries. The Aarmos runtime is one conforming producer; it is not authoritative over this specification.
...
the public `Aarmatix/avar` repository; the Aarmos runtime is one conforming
