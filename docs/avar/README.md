...
| [`IMPLEMENTATION.md`](./IMPLEMENTATION.md) | Normative. What it means to *be* an AVAR implementation: conformance requirements, invariants, version layers, publication gate. |
